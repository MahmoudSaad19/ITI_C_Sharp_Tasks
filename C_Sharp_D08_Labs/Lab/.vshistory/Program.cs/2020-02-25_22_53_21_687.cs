    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var dataset = from product in ProductList
                           ...
                           into product_Group
                           let pp = product_Group.Max(prd => prd.UnitPrice)
                           select new { category = product_Group.Key, product = product_Group.Where(prod => prod.UnitPrice == pp).FirstOrDefault(), productprice = pp };
