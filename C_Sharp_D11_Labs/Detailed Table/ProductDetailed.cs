    ...
    public partial class ProductDetailed : Form
    {
        ...
        private void productBindingNavigatorSaveItem_Click(object sender , EventArgs e)
        {
            ...
            foreach (var item in products)
            {
                ...
                {
                    ProductsManager.UpdateProductByProductID(item.ProductID, item.ProductName, item.QuantityPerUnit, item.UnitPrice, item.UnitsInStock, item.UnitsOnOrder, item.ReorderLevel, item.Discontinued);
                }
            }
        }
        ...
        private void btnDelete_Click(object sender , EventArgs e)
        {
            ...
            if (ProductsManager.DeleteProductByProductID(ProductID))
