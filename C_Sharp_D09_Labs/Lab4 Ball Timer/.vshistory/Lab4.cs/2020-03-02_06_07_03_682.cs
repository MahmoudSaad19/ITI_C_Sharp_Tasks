...
namespace Lab4_Ball_Timer
{
    public partial class Lab4 : Form
    {
        ...
        {
            graphics.FillEllipse(Brushes.DarkGoldenrod, val, 520, 75, 75);
            graphics.DrawEllipse(Pens.Gray, val, 520, 75, 75);
            graphics.DrawLine(Pens.Black, val+30, 490, val + 45, 565);
            base.OnPaint(e);
        }
