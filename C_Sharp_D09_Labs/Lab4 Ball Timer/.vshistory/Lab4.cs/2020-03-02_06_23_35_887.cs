...
namespace Lab4_Ball_Timer
{
    public partial class Lab4 : Form
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            graphics.FillEllipse(Brushes.Black, val+12, 530, 20, 20);
            graphics.FillEllipse(Brushes.Black, val+50, 530, 20, 20);
            graphics.FillEllipse(Brushes.Black, val+12, 570, 20, 20);
            graphics.FillEllipse(Brushes.Black, val+50, 570, 20, 20);
            graphics.DrawEllipse(Pens.Black, val, 520, 75, 75);
            graphics.DrawEllipse(Pens.Black, val, 520, 76, 76);
