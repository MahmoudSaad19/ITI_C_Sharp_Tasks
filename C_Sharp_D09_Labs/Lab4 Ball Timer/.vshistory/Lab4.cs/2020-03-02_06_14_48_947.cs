...
namespace Lab4_Ball_Timer
{
    public partial class Lab4 : Form
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            graphics.FillEllipse(Brushes.Black, val, 530, 15, 5);
            graphics.DrawEllipse(Pens.Black, val, 520, 75, 75);
            graphics.DrawEllipse(Pens.Black, val+27, 520, 25, 25);
            graphics.DrawEllipse(Pens.Black, val+27, 570, 25, 25);
            graphics.DrawEllipse(Pens.Black, val, 545, 25, 25);
            graphics.DrawEllipse(Pens.Black, val+40, 545, 25, 25);
            base.OnPaint(e);
        }
