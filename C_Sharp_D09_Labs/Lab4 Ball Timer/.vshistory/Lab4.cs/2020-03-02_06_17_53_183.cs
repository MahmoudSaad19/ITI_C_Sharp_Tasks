...
namespace Lab4_Ball_Timer
{
    public partial class Lab4 : Form
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            graphics.FillEllipse(Brushes.Black, val, 530, 15, 15);
            graphics.FillEllipse(Brushes.Black, val+55, 530, 15, 15);
            graphics.FillEllipse(Brushes.Black, val, 580, 15, 15);
            graphics.FillEllipse(Brushes.Black, val+55, 580, 15, 15);
