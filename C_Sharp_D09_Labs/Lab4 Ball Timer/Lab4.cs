...
namespace Lab4_Ball_Timer
{
    public partial class Lab4 : Form
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            graphics.FillEllipse(Brushes.Black, val+48, 530, 20, 20);
            graphics.FillEllipse(Brushes.Black, val+7, 570, 20, 20);
            graphics.FillEllipse(Brushes.Black, val+48, 570, 20, 20);
