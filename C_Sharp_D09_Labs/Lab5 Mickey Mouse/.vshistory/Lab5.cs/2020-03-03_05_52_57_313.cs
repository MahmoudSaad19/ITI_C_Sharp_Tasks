...
namespace Lab5_Mickey_Mouse
{
    public partial class Lab5 : Form
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            path2.AddEllipse(240, 260, 40, 50); // left eye
            path2.AddEllipse(370, 260, 40, 50); // right eye
            path2.AddEllipse(270, 300, 110, 70); //nose
            path2.AddBezier(250, 400, 300, 450, 350, 450, 400, 400); //mouth
            path2.CloseFigure();

            path3.AddEllipse(260, 190, 60, 120); // left eye
            path3.AddEllipse(330, 190, 60, 120); // right eye
